...
@NamedQueries({
    ...
    @NamedQuery(name = "RoomType.findByCode", query = "SELECT r FROM RoomType r WHERE r.code = :code")})
public class RoomType implements Serializable {
    ...
    public RoomType(Integer id, String code) {
        this.id = id;
        this.code = code;
    }
    ...
    public String toString() {
        return "com.se214h12.nhom4.model.RoomType[ id=" + id + " ]";
    }
